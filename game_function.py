...
def check_events(ai_settings,screen,stats,sb,play_botton,ship,aliens,
...
def check_play_botton(ai_settings,screen,stats,sb,play_botton,ship,
aliens,bullets,mouse_x,mouse_y):
	#玩家单击开始游戏
